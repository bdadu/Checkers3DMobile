...
function QueenCrown({ position }: { position: [number, number, number] }) {
  const { scene } = useGLTF('/models/crown.glb'); // pune modelul în public/models
  return <primitive object={scene} position={position} scale={[0.3, 0.3, 0.3]} />;
}
