...
function GamePage({ initialLevel }: GamePageProps) {
  ...
  return (
    ...
    <View style={styles.gameGrid} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd}>
      ...
      <Pressable style={[style.playAgainBtn, { position: 'absolute', bottom: 40, alignSelf: 'center' }]} onPress={handlePlayAgain}>
        <RNText style={style.playAgainText}>START AGAIN</RNText>
      </Pressable>
