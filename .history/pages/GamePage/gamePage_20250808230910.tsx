...
const styles = StyleSheet.create({
  ...
  scoreRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 2 },
  scoreLabel: { color: '#FAE7C9', fontWeight: '600' },
  scoreValue: { color: '#FFE0B5', fontWeight: '800' },

  // GameOver
  gameOverText: { color: 'white', fontSize: 28, fontWeight: '800', marginBottom: 20 },
  playAgainBtn: {
  ...
  playAgainText: { color: '#111', fontWeight: '800' },
});